...
class UserService {
    ...
    public async register(
        ...
        try {
            ...
            await sendEmail({
                from: 'emmyshoppinghub@gmail.com',
                to: user.email,
    ...
    public async updateUserDetails(
        updateData: UpdateUserDetailsInterface,
        userId: string
    ): Promise<string | Error> {
    ...
    public async updateUserPassword(
        updatePasswordInput: UpdateUserPasswordInterface,
        userId: string
    ): Promise<string | Error> {
    ...
    public async deleteUser(
        deleteUserInput: DeleteUserInterface,
        userId: string
    ): Promise<string | Error> {
